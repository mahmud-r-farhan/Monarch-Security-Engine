...
const Header = ({ onImageUpload, onExport, isDarkMode, setIsDarkMode, colorFormat, setColorFormat, language, setLanguage, onNewCanvas }) => {
  ...
  const handleNewCanvas = () => {
    ...
    if (width && height) {
      onNewCanvas(parseInt(width), parseInt(height));
    }
  };
